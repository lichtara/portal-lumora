...
### Sistema LICHTARA · Motor de Ressonância Viva

O **Portal Lumora** é uma experiência interativa de presença, escuta simbólica e autorregulação sensível.

Ele não é um app de produtividade.
...
O Portal Lumora é sustentado pelo:

### **ASRE — Adaptive Symbolic Resonance Engine**

*(Motor de Ressonância Viva por Inclinação Simbólica)*
...
* **Micropercursos Profundos (sistêmicos)**
  ...
  → não existem como texto contínuo

* **Micropercursos Declarativos (documentais)**
  → registrados em `/assets/text/micropercursos`
  → servem como mapas conscientes e reflexão

Essas duas camadas **não competem**.
...
```
/assets
  /audio        → paisagens sonoras e microeventos
...
style.css       → atmosfera visual e sensorial
```
...
* Não cria perfis psicológicos
* Não avalia escolhas
* Não gera recomendações comportamentais
* Não induz decisões externas

O Portal **não diz quem você é**.
Ele apenas sustenta um espaço onde algo pode ser percebido.
...
> **Nada aqui precisa ser acreditado.
> Basta ser vivido.**
